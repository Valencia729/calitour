...
<br>
La información del sitio se actualizó correctamente<br>
<a href="list.php">Regresar a la lista de edición</a> | <a href="admin.php">Agregar otro sitio</a> | <a target="_blank" href="clasifier.php?id=<?php echo $id;?>">Ver el sitio</a>
</div>
</div>
