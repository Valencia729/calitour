...
<div class="content">
  <div id=titulo>
    ...
    <p style="font-size:16px;">¿Esta seguro de eliminar <?php echo $nombre;?>?<br></p>
  </div>  <br>
  <div class="centrado">
  <a class="controles_e" href="delete.php?id=<?php echo $id;?>" title="Eliminar">Si</a>
  <a class="controles_e" href="list.php" title="Listado de sitios">No</a>
	<p>Esta operación no tiene reversa</p>
  </div>
