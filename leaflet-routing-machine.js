    ...
    "v5": {
        ...
        "depart": {
            "default": {
                ...
                "name": "Inicie {direction} sobre {way_name}",
                "namedistance": "Inicie {direction} sobre {way_name} por {distance}"
            }
        },
        "end of road": {
            "default": {
                "default": "Gire {modifier}",
                "name": "Gire {modifier} sobre {way_name}",
                "destination": "Gire {modifier} hacia {destination}"
            },
            "straight": {
                "default": "Continue straight",
                "name": "Continue recto sobre {way_name}",
                "destination": "Continue recto hacia {destination}"
            },
            "uturn": {
                "default": "Make a U-turn at the end of the road",
                "name": "Haga un cambio de sentido en {way_name} Al final del camino",
                "destination": "Haga un cambio de sentido hacia {destination} Al final del camino"
            }
        },
        "fork": {
            "default": {
                "default": "Keep {modifier} at the fork",
                "name": "Mantengase {modifier} sobre {way_name}",
                "destination": "Mantengase {modifier} hacia {destination}"
            },
            "slight left": {
                "default": "Keep left at the fork",
                "name": "Mantengase a la izquierda sobre {way_name}",
                "destination": "Mantengase a la izquierda sobre {destination}"
            },
            "slight right": {
                "default": "Keep right at the fork",
                "name": "Mantengase a la derecha sobre {way_name}",
                "destination": "Mantengase a la derecha sobre {destination}"
            },
            "sharp left": {
                "default": "Take a sharp left at the fork",
                "name": "Gire a la izquierda en {way_name}",
                "destination": "Gire bruscamente a la izquierda hacia {destination}"
            },
            "sharp right": {
                "default": "Gire a la derecha en la bifurcación",
                "name": "Gire a la derecha en {way_name}",
                "destination": "Gire a la derecha hacia {destination}"
            },
            "uturn": {
                "default": "Make a U-turn",
                "name": "Haga un cambio de sentido en {way_name}",
                "destination": "Haga un cambio de sentido hacia {destination}"
            }
        },
        "merge": {
            "default": {
