...
<head>
	...
	<title>Cali Tour 360 | COP16</title>
    <meta property="og:url"           content="https://www.calitour360.com/" />
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="Cali tour 360 | COP16" />
    <meta property="og:description"   content="Sistema de información geográfico 360 categoria COP16 Cali, sonidos de aves presentes en la Universidad del Valle" />
...
<?php
  ...
  <div class=wrapper_krpano>
    ...
    <img src='imagenes/cop_title.png' class=categoria_v alt="Gestor de busqueda para sitios turísticos de Cali">
...
<script>
 ...
 function openModal(hotspotId) {
        ...
        xhr.open('GET', 'get_hotspot_info.php?id=' + hotspotId, true);
        xhr.onload = function() {
            if (xhr.status === 200) {
...
<a href="https://www.facebook.com/sharer/sharer.php?u=http://www.calitour360.com/" title="Comparte en Facebook"><img src="imagenes/facebook.png" height="20px"></a> 
    <a href="https://api.whatsapp.com/send?text=Hola!, te invito a escuchar los sonidos de aves presentes en nuestro campus universitario Meléndez con Cali tour 360 - Sistema de Información Geográfico turístico de Cali 360. http://www.calitour360.com/cop"  title="Comparte en whatsapp"><img src="imagenes/whatsapp.png" height="20px"></a> 
...
?>
<div class=leyenda_filtro_v><img src=imagenes/sonidos.png height=15px> Sonido de ave | <a href="categorias.html">Otras categorias</a>
<br>
</div>
